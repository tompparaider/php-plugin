<?php
// Tätä osiota muokkasin hieman, esim default vastauksiksi 'yes,no', toinen osio mitä muokkasin on alempaa löytyvä user data
class wp_polls {
	...
	function activate() {
		...
		if(get_option('polls_db_version') != $this->db_version) {
			...
			// Remember the version of the plugin the checkout DB was setup with for upgrades.
	...
	// User data... Tätäkin on vähän tullut rustattua jotta käyttäjätkin pääsevät tekemään kyselyitä
